...
def pregunta_01():
    ...
    file_in = "files/input/solicitudes_de_credito.csv"
    file_out = "files/output/solicitudes_de_credito.csv"

    dats = pd.read_csv(file_in, sep=";")
    ...
    dats.to_csv(file_out, sep=";", index=False)
